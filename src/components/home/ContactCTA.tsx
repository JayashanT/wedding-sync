  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          Contact Wedding Invite SL to set up Wedding Sync for your special day.
          Our team will create your wedding profile and provide access codes for your team.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <a
            href="mailto:infoweddinginvitesl@gmail.com"
        ...
        <div
          ...
          style={{ borderColor: 'rgba(255,255,240,0.1)', color: 'rgba(255,255,240,0.5)' }}
        >
          Powered by{' '}
